  ...
  return (
    <div className="space-y-6">
      ...
      <section className="overflow-hidden rounded-[22px] border border-slate-200/80 bg-white shadow-[0_8px_28px_rgba(15,23,42,0.04)]">
        ...
        <div className="flex items-center justify-between gap-3 px-4 py-3 sm:px-5">
          <p className="text-sm text-slate-500">
            ...
            {pagination.totalRecords === 1 ? "category" : "categories"}
          </p>
          <Button
            variant="secondary"
            size="sm"
      ...
      <Modal
        ...
        onClose={closeModals}
        title="Add Category"
        description="Create a searchable category for medicine records."
      >
        <CategoryForm
      ...
      <Modal
        ...
        onClose={closeModals}
        title="Edit Category"
        description="Update the selected category information."
      >
        <CategoryForm
      ...
      <ConfirmDialog
        ...
        description={
          activating
            ? "The category will become available for active medicine selections."
            : "Medicines may remain linked, but this category will no longer be available for new active selections."
        }
