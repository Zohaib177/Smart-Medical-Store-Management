...
const fromDb = { stock_in: 'stockIn', stock_out: 'stockOut', correction: 'correction', adjustment: 'correction' };
const toDb = { stockIn: 'stock_in', stockOut: 'stock_out', correction: 'correction' };
