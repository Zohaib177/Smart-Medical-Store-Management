...
class Medicine extends BaseModel {
  ...
  async findByIdForUpdate(id, connection) { const [rows] = await connection.execute('SELECT id,medicine_name,stock_quantity,minimum_stock FROM medicines WHERE id=? FOR UPDATE',[id]); return rows[0]||null; }
